...
function MarqueeRow({ images, transform }: { images: string[]; transform: string }) {
  return (
  ...
  return (
    <section ref={sectionRef} className="bg-[#0C0C0C] pt-24 sm:pt-32 md:pt-40 pb-10 overflow-hidden">
      <div className="flex flex-col gap-3">
        <MarqueeRow images={TRIPLE_ROW_1} transform={`translateX(${offset - 200}px)`} />
        <MarqueeRow images={TRIPLE_ROW_2} transform={`translateX(${-(offset - 200)}px)`} />
      </div>
    </section>
  );
}
